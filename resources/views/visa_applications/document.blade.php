<x-main-layout>
    ...
    <form action="{{ route('uploadDocument') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class=" mx-auto  col-md-10">
            <div class="outline-success mb-4 d-flex" > 
                <span class="ml-2 font-weight-bolder h5 text-success" style=" height: 50px; width: 300px; line-height: 50px;">1. Submit Application Online</span>
                <div style="clip-path: polygon(75% 0%, 100% 50%, 65% 100%, 0% 100%, 12% 47%, 3% 0%);" >
                    <div class="bg-success" style="height: 50px; width: 400px; line-height: 50px;"> <span class="ml-5 font-weight-bolder h5">2. Submit Documents</span>
                    </div>
                    </div> 
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 text-right"> 
                <div style="clip-path: polygon(100% 0%, 100% 47%, 100% 100%, 5% 100%, 0% 50%, 5% 0%);" >
                    <div class="bg-success" style="width: 100px;"><a href="{{ route('editUserInfo') }}"> <button type="button" class="btn btn-success bg-success">Back</button></a>
                    </div>
                </div>
